...
public class HumanExplorer implements Explorers {
    @Override
    ...
    public void visit(Neptune neptune) {
        System.out.println("Deploying tools specific to Neptune... explored life");
    }

    @Override
    public void visit(Uranus uranus) {
        System.out.println("Deploying tools specficic to Uranus... exploring life");
    }
}